          ...
          <div className="text-center mb-10">
            ...
            <div className="mt-8">
              ...
              <p className="text-gray-500 mt-1">
                {role === 'owner' ? 'Register your canteen' : 'Join as a Student'}
              </p>
            </div>
          </div>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-[#fff4ee] items-center justify-center">
        ...
        <div className="z-10 text-center max-w-sm">
          ...
          <h3 className="text-4xl font-black text-[#1f2937] leading-tight mb-4">
            Join the <br />
            <span className="text-[#ff6b00]">Foodie Community</span>
          </h3>
          <p className="text-gray-500 text-lg">
            Register now and start experiencing the easiest way to order food on campus.
          </p>
        </div>
      </div>
    </div>
